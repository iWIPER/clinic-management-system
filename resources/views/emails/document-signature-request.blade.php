...
<head>
    ...
    <title>Assinatura pendente — {{ $document->template_name }}</title>
    <style>
...
<div class="card">
    ...
    <div class="body">
        <p class="greeting">
            Olá, <strong>{{ $patientName ?? 'Paciente' }}</strong>!<br/><br/>
            <strong>{{ $clinicName }}</strong> enviou o documento abaixo para sua assinatura eletrônica.
        </p>

        <div class="info-box">
            <div class="info-row">
                <span class="info-label">Documento</span>
                <span class="info-value">{{ $document->template_name }}</span>
            </div>
            <div class="info-row">
        ...
        <div class="cta-section">
            <a href="{{ $signUrl }}" class="cta-btn" target="_blank" rel="noopener">
